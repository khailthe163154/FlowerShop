    ...
    <body class="biolife-body">
        ...
        <div class="page-contain">
            ...
            <div id="main-content" class="main-content">
                <h1 style="color: black; font-weight: 600;text-align: center; ">Trang chu</h1>
                            ...
                            <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                                <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                                    <li class="tab-element">
                                        <h1 style="color: black; font-weight: 600; ">Moi Cap Nhat</h1>
                                    </li>
                                        ...
                                        <c:forEach var="p" items="${plist}">
                                            ...
                                            <li class="product-item col-lg-4 col-xs-6">
                                                <div class="contain-product layout-default">
                                                    ...
                                                    <div class="info">
                                                        <h4 class="product-title" style="margin-top: 25px;"><a href="./ProductDetails?pid=${p.getId()}" class="pr-name">Name: ${p.getName()}</a></h4>
                                                        <div class="price">
                                        ...
                                        <c:forEach var="p" items="${plist1}">
                                            ...
                                            <li class="product-item col-lg-4 col-xs-6">
                                                <div class="contain-product layout-default">
                                                    ...
                                                    <div class="info">
                                                        <h4 class="product-title" style="margin-top: 25px;"><a href="./ProductDetails?pid=${p.getId()}" class="pr-name">${p.getName()}</a></h4>
                                                        <div class="price">
                                                            <ins><span class="price-amount">Price: <span class="currencySymbol">$</span>${p.getPrice()}</span></ins>
